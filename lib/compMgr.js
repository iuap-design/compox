...
import { hasClass } from 'tinper-sparrow/src/dom';
import { inArray } from 'tinper-sparrow/src/util';
...
function _upgradeElement(element, optJsClass) {
    if (!((typeof element === 'undefined' ? 'undefined' : babelHelpers['typeof'](element)) === 'object' && element instanceof Element)) {
...
var CompMgr = {
    ...
    apply: function apply(options) {
        ...
        if (_el == null || (typeof _el === 'undefined' ? 'undefined' : babelHelpers['typeof'](_el)) != 'object') _el = document.body;
